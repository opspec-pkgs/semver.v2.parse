[![Build Status](https://github.com/opspec-pkgs/semver.v2.parse/workflows/build/badge.svg?branch=main)](https://github.com/opspec-pkgs/semver.v2.parse/actions?query=workflow%3Abuild+branch%3Amain)
